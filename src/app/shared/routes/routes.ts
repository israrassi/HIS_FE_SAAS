export class routes {
  ...
  //Start Custom
  public static get UserListRoute(): string {
    return this.baseUrl + '/settings/users';
  }
  public static get LookupsRoute(): string {
    return this.baseUrl + '/settings/lookups';
  }
  public static get PatientsRoute(): string {
    return this.baseUrl + '/settings/patients';
  }
  public static get DoctorsRoute(): string {
    return this.baseUrl + '/settings/doctors';
  }
  public static get DepartmentsRoute(): string {
    return this.baseUrl + '/settings/departments';
  }
  public static get ServicesRoute(): string {
    return this.baseUrl + '/settings/services';
  }
  public static get VisitAutoServiceRoute(): string {
    return this.baseUrl + '/settings/visitautoservice';
  }
  public static get AppointmentSetup(): string {
    return this.baseUrl + '/appointment/setup';
  }

  public static get AppointmentList(): string {
    return this.baseUrl + '/appointment/list';
  }
  public static get VisitList(): string {
    return this.baseUrl + '/visits';
  }
