      ...
      menu: [
...

        {
          ...
          subMenus: [
            {
              menuValue: 'Users',
              route: routes.UserListRoute,
              base: routes.UserListRoute,
            },
            {
              menuValue: 'Lookups',
              route: routes.LookupsRoute,
              base: routes.LookupsRoute,
            },
            {
              menuValue: 'Patients',
              route: routes.PatientsRoute,
              base: routes.PatientsRoute,
            },
            {
              menuValue: 'Doctors',
              route: routes.DoctorsRoute,
              base: routes.DoctorsRoute,
            },
            {
              menuValue: 'Departments',
              route: routes.DepartmentsRoute,
              base: routes.DepartmentsRoute,
            },
            {
              menuValue: 'Services',
              route: routes.ServicesRoute,
              base: routes.ServicesRoute,
            },
            {
              menuValue: 'Visit Auto Service',
              route: routes.VisitAutoServiceRoute,
              base: routes.VisitAutoServiceRoute,
            }
          ],
        },
        {
          ...
          subMenus: [
            ...
            {
              menuValue: 'Visit List',
              route: routes.VisitList,
              base: routes.VisitList,
            },
          ],
        },
        {
